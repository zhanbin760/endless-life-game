...
WEEKLY_DATA = [
    {
        ...
        "icon": "📝",
        "color": "#4A6FA5",
        "summary": "每天记录，在你的认知回路中插入\"处理\"环节。不求完美，只求开始。",
        "tools": [
            {"name": "第一性原理", "summary": "回到\"为什么\"", "detail": "记录的第一性原理：今天的你，替未来的你，留下一点东西。不求有用，只求真实。不求深刻，只求存在。降低启动成本，是长期主义的第一步。"},
            {"name": "元认知", "summary": "对思考的思考", "detail": "记录就是元认知的最小化实践。当你写下\"我今天有点焦虑\"的那一刻，你就在做两件事：感受焦虑（本能），观察自己在焦虑（元认知）。这两件事之间的距离，就是普通人和高手的差距。"},
        ...
        "days": [
            {
                ...
                "content": """<h3>🎯 目标：写下第一条记录</h3>
<p>你有没有过这样的体验——刷了一天手机，晚上躺在床上回想，好像什么都没留下。那些看过的文章、听过的播客、群里讨论过的话题，像沙子一样从指缝漏掉了。</p>
<p>这不是你的记忆力出了问题。</p>
<p><strong>认知回路（Cognitive Loop）</strong>——人的认知是一个"输入→处理→输出"的闭环。信息进来，你消化它，然后产生新的想法或者行动——这才是一个完整的回路。</p>
<p>问题在于，大多数人的回路是断的。信息进来，没有经过思考的消化，直接就流失了。</p>
<p><strong>你不是没有想法。你是没有给想法一个"停留"的机会。</strong></p>
<p>每日真实记录，就是强行在你的认知回路里插入一个"处理"环节。哪怕只写三句话，你也在做一件事：让信息在你脑子里多待一会儿，被你真正消化。</p>
<h4>具体做法：</h4>
<ul><li>选一个模板。推荐从「每日复盘」或「碎片灵感」开始</li><li>今天就写。不要等到"有灵感"，不要等到"有整块时间"</li><li>哪怕只写3句话，也算完成</li></ul>
<p><strong>第一天最大的敌人不是"写得不好"，是"还没开始写"。</strong></p>""",
                "prompts": [
...
（最小行动，一句话说完）"""}
            ...
            },
            {
                ...
                "content": """<h3>🎯 目标：尝试不同模板，找到感觉</h3>
<p>你已经迈出了第一步。现在，让记录变得更有趣一点。</p>
<p><strong>元认知（Meta-cognition）</strong>——万维钢区分"高手"和"普通人"的关键概念。普通人只知道自己在想什么，高手能观察自己在怎么想。</p>
<p>记录，就是元认知的最小化实践。当你写下文字的那一刻，你就在审视自己的想法。</p>
<h4>具体做法：</h4>
<ul><li>换一种模板记录。比如之前用「每日复盘」，今天试试「碎片灵感」或「问题追踪」</li><li>用 AI 帮你扩展一个灵感碎片（但记住：AI 是你的镜子，不是你的嘴替）</li><li>在社群里分享一个你记录中的发现</li></ul>
<p>万维钢说："输出是最高效的输入方式。"</p>""",
                "prompts": [
...
注意：请用简洁、有温度的语言，不要套话和鸡汤。"""}
            ...
            },
            {
                ...
                "content": """<h3>🎯 目标：回顾一周，发现模式，确定节奏</h3>
<p>一周即将结束。你可能觉得"也没写什么了不起的东西"。</p>
<p>这正是重点——记录的价值不在于任何单一条目，而在于积累本身形成的<strong>认知密度</strong>。你还没看到效果，是因为时间还不够长。</p>
<p><strong>反脆弱</strong>——每天写三句话，看似微不足道，但它具备反脆弱的特征：低成本、高频次、收益不可预测但长期复利。</p>
<h4>具体做法：</h4>
<ul><li>通读这周的所有记录</li><li>问自己：有没有什么让我<strong>惊讶</strong>的发现？</li><li>用 AI 复盘整理提示词分析一周</li><li>确定最适合你的记录节奏和模板</li></ul>
<p>不一定每天都要记，但一定要持续。</p>""",
                "prompts": [
...
（安慰？行动？休息？还是更多信息？）"""}
    ...
    },
    {
        ...
        "tools": [
            {"name": "反常识", "summary": "先有骨架，再填血肉", "detail": "好文章是"组装"出来的，不是"灵感涌现"出来的。先确定"这篇文章要说什么"（骨架），再往每个部分填内容。AI 可以帮你搭骨架，但它不能替你填灵魂。"},
            {"name": "弱联系", "summary": "创新来自连接", "detail": "你第一周记录的碎片看起来分散、不相关。但当你把它们放在一起，你会发现"弱联系"——灵感碎片 A 和情绪日记 B 可能在说同一件事。创作的本质，就是发现弱联系并把它们连接起来。"},
            {"name": "最小可行产品 (MVP)", "summary": "先完成，再完美", "detail": "第二周的目标不是写出一篇"爆款"，而是写出一篇完整的作品。完整的意思是：有开头、有中间、有结尾，逻辑通顺，表达清楚。完成比完美重要——只有完成了，你才有东西可以迭代。"}
        ],
        "quote": "如果你不能说清楚一件事，说明你还没想清楚。完成比完美重要——只有完成了，才有迭代的机会。",
        "days": [
            {
                "id": "w2-d1", "period": "Day 8-9", "title": "拆解与选材", "subtitle": "从记录中挖掘宝藏",
                "content": """<h3>🎯 目标：从第一周记录中选出最有感觉的素材</h3>
<p>大多数人以为写作是这样的：坐在电脑前，灵感涌现，笔走龙蛇，一气呵成。如果有哪天灵感不来，就"写不出来"。</p>
<p><strong>这是幻觉。</strong></p>
<p>好的作品不是"等灵感来了写出来的"，而是<strong>"组装出来的"</strong>。</p>
<p>第一周你做的记录，就是在收集这些散落的碎片。第二周我们要做的事，就是把这些碎片组装成一件完整的作品。</p>
<p>方法叫<strong>"借骨还魂术"</strong>：</p>
<ul><li><strong>借骨</strong>：用 AI 帮你搭好文章的结构（骨架）</li><li><strong>还魂</strong>：你往骨架里填入自己真实的经历、想法和语言（灵魂）</li></ul>
<h4>具体做法：</h4>
<ul><li>重读你第一周的所有记录</li><li>标记出让你有感觉的条目——不是"写得最好"的，而是"最有情绪共鸣"的</li><li>至少选出 3 条</li></ul>
<p>问自己：这条记录为什么打动了我？它和我生活中的哪些经历有关？如果我要围绕这个主题写一篇文章，我会说什么？</p>""",
                "prompts": [
                    {"name": "🔍 素材筛选提示词", "text": """以下是我第一周的所有记录：
[粘贴所有记录]

请帮我：
1. 识别出 3 条最有"能量"的记录（最有情绪共鸣、最值得深挖的）
2. 对每条记录，说明它可能的"主题方向"
...
4. 推荐一个最值得优先创作的主题"""}
            ...
            },
            {
                ...
                "content": """<h3>🎯 目标：用 AI 把选出的素材搭成文章结构</h3>
<p><strong>创新来自弱联系</strong>——万维钢多次引用社会学中的"弱联系"理论：真正有价值的创新和信息，往往不是来自你熟悉的人，而是来自你不太熟的人。</p>
<p>这个原理同样适用于创作。你第一周记录的碎片灵感、每日复盘、情绪日记——它们看起来是分散的、不相关的。但当你把它们放在一起看，你会发现一些"弱联系"。</p>
<p>创作的本质，就是发现弱联系并把它们连接起来。</p>
<h4>具体做法：</h4>
<ul><li>把你选出的素材和主题发给 AI，让它帮你搭一个文章骨架</li><li>审视 AI 搭的骨架：你觉得这个结构好吗？有没有想调整的地方？</li><li>大胆改——这是你的文章，AI 只是助手</li></ul>
<p><strong>关键原则：AI 搭骨（结构），你填魂（真实内容）。</strong></p>""",
                "prompts": [
...
5. 模仿我的风格，重写下面这段话：[输入一段你想润色的文字]"""}
            ...
            },
            {
                ...
                "content": """<h3>🎯 目标：完成第一篇完整作品并发布</h3>
<p>万维钢讲创业和产品时经常用<strong>MVP（Minimum Viable Product）</strong>概念：不要追求一次性做出完美产品，先做一个"刚好能用"的版本，发布出去，根据反馈迭代。</p>
<p>写文章也是一样。第二周的目标不是写出一篇"爆款"，而是写出一篇<strong>完整</strong>的作品。</p>
<p>它可以不惊艳、不深刻、不精致。但它必须是完整的。</p>
<h4>具体做法：</h4>
<ul><li><strong>Day 12 填内容：</strong>按照骨架，往每个部分填入你的真实经历、想法和语言。不要追求完美，先把骨架填满。</li><li><strong>Day 13 打磨：</strong>用 AI 内容润色提示词优化表达，但保持自己的味道</li><li><strong>Day 14 发布：</strong>在社群、朋友圈或公众号发布。接受反馈，不要害怕。</li></ul>
<p>AI 给你效率，你给文章灵魂。这就叫借骨还魂。</p>""",
                "prompts": [
...
重要：不要改写成"AI 风格"的文章。保持真实、朴素的语气。如果某段已经很好，请直接说"这段很好，无需修改"。"""}
                ],
    ...
    },
    {
        ...
        "icon": "🧠",
        "color": "#6B8F71",
        "summary": "不再只是记录发生了什么，而是用思维工具分析为什么、怎么办。把思维模型从\"知道\"变成\"用过\"。",
        "tools": [
            ...
            {"name": "多元思维模型", "summary": "一个问题，多个角度", "detail": "万维钢把芒格的"多元思维模型"理念做了实操化拆解。当你只有一个锤子，所有问题看起来都像钉子。但如果你有一个工具箱，你就能根据问题选择最合适的工具。本周每天用一个不同的思维框架分析一个真实问题。"},
            {"name": "二阶思维", "summary": "想一步，再想一步", "detail": "大多数人的思考停留在"如果我做了 A，会直接得到什么结果"。但高手会继续问："这个结果的后果是什么？后果的后果呢？" 一阶思维看直接结果，二阶思维看间接结果，三阶思维看连锁反应。"}
        ],
        ...
        "days": [
            {
                ...
                "content": """<h3>🎯 目标：用费曼技巧"讲清楚"一个你真正在意的问题</h3>
<p>你可能听说过"第一性原理"。你可能也知道"机会成本"这个词。你甚至能用它们侃侃而谈。</p>
<p>但问题来了：你上一次在做一个真实的人生决策时，主动用一个思维框架来分析，是什么时候？</p>
<p><strong>知道和做到之间，隔着一道巨大的鸿沟。</strong></p>
<p>费曼技巧的核心只有一句话：如果你不能用最简单的语言给一个外行讲清楚一件事，说明你自己也没理解透。</p>
<h4>具体做法：</h4>
<ul><li>从前两周的记录中，选一个"反复出现但说不清楚"的主题</li><li>假设对面坐着一个完全不懂这个话题的朋友</li><li>用大白话讲给他听——录音或者打字都可以</li><li><strong>找到卡壳的地方——那就是你思维的盲区</strong></li><li>记录：哪里卡壳了？为什么卡壳？需要补充什么信息？</li></ul>""",
                "prompts": [
...
🔄 再讲一遍（修订后）："""}
            ...
            },
            {
                ...
                "content": """<h3>🎯 目标：每天用一个思维框架分析一个真实问题</h3>
<p>万维钢把芒格的"多元思维模型"理念做了实操化拆解。核心观点是：当你只有一个锤子，所有问题看起来都像钉子。但如果你有一个工具箱，你就能根据问题选择最合适的工具。</p>
<p>关键要求：必须用在你自己的真实问题上，不是做练习。</p>
<h4>Day 17：第一性原理</h4>
<p>问自己：我这个问题的最底层是什么？剥掉所有的"应该""别人觉得""社会期望"，剩下的核心是什么？</p>
<h4>Day 18：机会成本</h4>
<p>每一次选择，你付出的不是你选的那个东西的价格，而是你放弃的那个东西的价值。选 A 你放弃 B，你真正放弃的是什么？那个放弃值得吗？</p>
<h4>Day 19：二阶效应</h4>
<p>一阶思维看直接结果。但高手问：这个结果的后果是什么？后果的后果呢？</p>
<h4>Day 20：奥卡姆剃刀 + 逆向思维</h4>
<p>如无必要，勿增实体——最简单的解释往往是正确的。</p>
<p>反过来想，总是反过来想。不要问"我怎么做才能成功"，问"我做什么一定会失败"——然后避免它。</p>""",
                "prompts": [
...
请帮我：
1. 识别这个问题中哪些是"社会默认假设"（别人都这么说/做）
2. 识别哪些是"真实约束"（物理/经济/时间的硬限制）
3. 剥到最底层：剥离所有假设后，问题的核心是什么？
4. 基于这个核心，有哪些我可能没想过的解决方向？"""},
                    {"name": "⚖️ 机会成本提示词", "text": """我正在用"机会成本"框架分析一个选择。
...
4. 有没有第三选项 C，能同时保留两边最重要的价值？"""},
                    {"name": "🔮 二阶效应提示词", "text": """我正在用"二阶思维"分析一个决定。
...
4. 基于这个分析，这个决定还值得做吗？有没有调整方案？"""},
                    {"name": "🪒 奥卡姆剃刀提示词", "text": """我正在用"奥卡姆剃刀"分析一个问题。
...
万维钢说："当你有两个理论都能解释现象，选更简单的那个。""""},
                    {"name": "🔄 逆向思维提示词", "text": """我正在用"逆向思维"分析一个目标。
...
4. 如果我要最少努力地达成这个目标，最低有效动作是什么？"""}
            ...
            },
            {
                ...
                "content": """<h3>🎯 目标：围绕本周的分析成果，完成第二篇作品</h3>
<p>第三周你做了大量思考：用费曼技巧找到了盲区，用不同的思维框架分析了真实问题。</p>
<p>现在，把这些分析成果变成一篇作品。</p>
<p>这次不再是凭感觉写，而是用思维框架驱动。你的文章会有一个清晰的分析结构，读者能跟着你的思路走。</p>
<h4>具体做法：</h4>
<ul><li>选一个本周最有感触的分析成果</li><li>用第二周学到的"借骨还魂术"搭骨架</li><li>填入本周的真实分析过程</li><li>发布并分享</li></ul>
<p><strong>从这一周开始，你不是在"记录"，你是在"思考"。</strong></p>""",
                "prompts": [
...
"id": "w4-d1", "period": "Day 22-24", "title": "设计系统", "subtitle": "画出你的认知飞轮",
                "content": """<h3>🎯 目标：设计你的个人知识操作系统</h3>
<p>前三周，你学会了记录、创作、思考。第四周，我们要把这三件事整合成一个系统——一个能自动运转的<strong>"个人知识操作系统"</strong>。</p>
<p>普通人和高手的差距，不在于智商，不在于努力程度，而在于——<strong>高手思考的是系统，普通人思考的是事件</strong>。</p>
<p>事件思维：今天又没记录，我得补上。系统思维：什么条件会让我更容易记录？→ 睡前把记录本放在枕边 → 自动触发。</p>
<h4>Day 22：画出你的认知飞轮</h4>
<ul><li><strong>输入端：</strong>想法和素材从哪里来？（日常经历、阅读、社交、工作、播客…）</li><li><strong>处理端：</strong>你怎么消化这些素材？（哪个记录模板？什么时间记？AI 辅助哪些环节？）</li><li><strong>输出端：</strong>你产出了什么？（文章？复盘？社群分享？）</li><li><strong>反馈端：</strong>你怎么知道自己进步了？（社群反馈？自我回顾？数据追踪？）</li></ul>
<h4>Day 23：设计你的记录系统</h4>
<p>写一份"个人记录系统说明书"，包括：什么时间记、用什么工具、用什么模板、怎么用 AI、存在哪里。</p>
<h4>Day 24：设计你的思维工具箱</h4>
<p>列出你最常用的 3-5 个思维框架，每个写清：框架名称、核心问题、适用场景、使用示例。</p>""",
                "prompts": [
...
2. 指出哪个环节最薄弱？怎么加强？
3. 推荐 3 个能让我飞轮加速的"杠杆点"
4. 帮我写一段"飞轮说明书"——用简洁的语言描述我的系统"""},
...
请帮我设计我的"个人思维工具箱"：
1. 推荐 3-5 个最适合我的框架组合
2. 每个框架配一个"触发问题"——遇到什么情况时调用它
3. 每个框架配一个"一句话记忆口诀"
4. 建议我优先熟练掌握哪 2 个框架？"""}
                ],
                "tasks": ["画出个人认知飞轮（输入→处理→输出→反馈）", "写一份\"个人记录系统说明书\"", "设计个人思维工具箱（3-5 个框架）"]
            },
            {
                "id": "w4-d2", "period": "Day 25-28", "title": "运行与固化", "subtitle": "让系统自动运转",
                "content": """<h3>🎯 目标：运行系统、调整优化、月度总结</h3>
<p>系统设计好了，现在让它转起来。</p>
<p><strong>习惯回路</strong>——任何习惯都由三部分组成：触发（Cue）、行动（Routine）、奖励（Reward）。</p>
<p>想建立一个习惯，不要靠意志力，要靠设计。</p>
<h4>Day 25：为每个习惯设计触发器</h4>
<ul><li>记录习惯的触发器：每晚刷完牙 → 坐到书桌前 → 打开记录</li><li>思考习惯的触发器：每周六上午 → 选一个问题 → 用费曼技巧讲一遍</li><li>创作习惯的触发器：每月最后一周 → 回顾本月记录 → 选素材 → 借骨还魂</li></ul>
<h4>Day 26：运行系统一天</h4>
<p>按你设计的系统完整运行一天，记录感受：哪里顺畅？哪里卡壳？哪里想调整？</p>
<h4>Day 27：调整优化</h4>
<p>根据运行体验微调系统，写出最终版<strong>"个人知识操作系统说明书"</strong></p>
<h4>Day 28：月度总结</h4>
<p>回顾四周的所有记录，回答：</p>
<ul><li>这四周，我的认知回路有什么变化？</li><li>我找到了哪些适合自己的记录方式和思维工具？</li><li>我的"认知飞轮"是什么样子？</li><li>下个月，我要怎么继续运转这个系统？</li></ul>""",
                "prompts": [
...
请帮我设计：
1. 3 种可能的"触发信号"（时间、地点、前序动作）
2. 找出最好的一个组合
3. 设计一个"奖励"——完成这个习惯后给自己什么正反馈
4. 如果某天没完成，设计一个"最低可行版本"（1 分钟搞定）"""},
...
- 多久做一次系统回顾："""}
                ...
                "tasks": ["为每个习惯设计触发器", "完整运行系统至少 1 天", "完成最终版\"个人知识操作系统说明书\"", "写完月度复盘"]
            }
        ]
    }
]
...
THINKING_TOOLS_DICT = [
    {"name": "第一性原理", "source": "物理学/亚里士多德 → 马斯克推广", "summary": "回到最底层，问\"这件事的本质是什么\"。剥掉所有社会默认假设，找到不可再拆解的核心真理。", "question": "这件事最底层的、不可再拆解的核心是什么？"},
    ...
    {"name": "二阶思维", "source": "决策理论", "summary": "不只问\"如果我做了 A 会怎样\"，还问\"那然后呢？那再然后呢？\"。考虑后果的后果。", "question": "这个结果的后果是什么？后果的后果呢？"},
    ...
    {"name": "最小可行产品 (MVP)", "source": "精益创业", "summary": "不求完美，先求完整。先做一个\"刚好能用\"的版本，发布出去，根据反馈迭代。", "question": "什么是最少努力就能完成的\"完整版本\"？"},
    {"name": "认知解耦", "source": "认知科学", "summary": "把\"心中的叙事\"和\"眼前的事实\"拆开。让情绪升起又消散，而自己不必跟着走。", "question": "我心中讲的故事和事实本身有多大差距？"},
    ...
    {"name": "场域理论", "source": "皮埃尔·布迪厄", "summary": "社会由多个相对独立的\"场域\"组成，每个场域有自己的规则和资本。努力不是硬通货，合规才是。", "question": "这个场域的规则是什么？我有没有在按不对的规则玩？"},
...
def render_tool_card(tool):
    with st.expander(f"**{tool['name']}** — {tool['summary']}"):
        ...
        st.markdown(f"**触发问题：** _{tool['question']}_")
...
def page_settings():
    ...
    st.markdown("### 🤖 AI 配置")
    st.markdown("配置你的 AI 接口信息以使用\"发送到 AI\"功能")
